...
class AbonnementService {
  static const String _baseUrl = 'http://192.168.1.14:8085/api/abonnements';
  ...
  Future<int> getAbonnementCount() async {
    try {
      ...
      return abonnements.length; // Retourner le nombre d'abonnements
    } catch (e) {
      print("Erreur lors de la récupération du nombre d'abonnements: $e");
      return 0;
    }
  }
